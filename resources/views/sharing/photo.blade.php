        ...
        <div class="header-Gallery">
            ...
            <div class="row justify-content-center text-center">
                <div class="col-lg-4 col-sm-6">
                    <select name="areashare" class="form-control"style="" id="exampleFormControlSelect1" data-route="{{ url('filter-data-photo') }}" data-csrf="{{ csrf_token() }} ">
                        <option value=""> </option>
                ...
                <div class="col-lg-3 col-sm-6">
                    ...
                    <a href="{{url('show-rang-photo/0/2')}}"  id="show-range" ><button type="submit" class="btn btn-primary">ترتيب حسب الاعلي تصويت</button></a>
                    ...
                    <div class="col-lg-4  col-md-6 col-sm-12">
                        <div class="card" style="width: 18rem;">
                            ...
                            <div class="overlaycon">
                                <a href="{{url('/show-photo/'.$item->id.'')}}"> <img   class="img-fluid" src="{{asset('photo/'.$item->photo.'')}}">
    ...
    countrySelectBox.onchange = function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                var url = "{{url('show-rang-photo')}}" + "/" + eduShare + "/" + "2";
                // console.log(url)
