    ...
    <div class="container">
        ...
        <div class="row justify-content-center text-center">
            <div class="col-lg-4 col-sm-6">
                <select name="areashare" class="form-control"style="" id="exampleFormControlSelect1" data-route="{{ url('filter-data-video') }}" data-csrf="{{ csrf_token() }} ">
                    <option value=""> </option>
            ...
            <div class="col-lg-3 col-sm-6">
                ...
                <a href="{{url('show-rang-video/0/6')}}"  id="show-range" ><button type="submit" class="btn btn-primary">ترتيب حسب الاعلي تصويت</button></a>
                ...
                <div class="col-lg-4  col-md-6 col-sm-12">
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="overlaycon">
                            <a href="{{url('/show-video/'.$item->id.'')}}"> <img   class="img-fluid" src="{{asset('img/video.jpg')}}">
    ...
    countrySelectBox.onchange = function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                var url = "{{url('show-rang-video')}}" + "/" + eduShare + "/" + "6";
                // console.log(url)
