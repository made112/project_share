    ...
    <div class="container">
        ...
        <div class="row justify-content-center text-center">
            <div class="col-lg-4 col-sm-6">
                <select name="areashare" class="form-control"style="" id="exampleFormControlSelect1" data-route="{{ url('filter-data-motion') }}" data-csrf="{{ csrf_token() }} ">
                    <option value=""> </option>
            ...
            <div class="col-lg-3 col-sm-6">
                ...
                <a href="{{url('show-rang-motion/0/8')}}"  id="show-range" ><button type="submit" class="btn btn-primary">ترتيب حسب الاعلي تصويت</button></a>
                ...
                <div class="col-lg-4  col-md-6 col-sm-12">
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="overlaycon">
                            <a href="{{url('/show-motion/'.$item->id.'')}}"> <img   class="img-fluid" src="{{asset('img/motion.jpg')}}">
    ...
    countrySelectBox.onchange = function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                var url = "{{url('show-rang-motion')}}" + "/" + eduShare + "/" + "8";
                // console.log(url)
