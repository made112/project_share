    ...
    <div class="container">
        ...
        <div class="row justify-content-center text-center">
            <div class="col-lg-4 col-sm-6">
                <select name="areashare" class="form-control"style="" id="exampleFormControlSelect1" data-route="{{ url('filter-data-drawing') }}" data-csrf="{{ csrf_token() }} ">
                    <option value=""> </option>
            ...
            <div class="col-lg-3 col-sm-6">
                ...
                <a href="{{url('show-rang-drawing/0/1')}}"  id="show-range" ><button type="submit" class="btn btn-primary">ترتيب حسب الاعلي تصويت</button></a>
                        ...
                        <section class="container d-flex align-content-start flex-wrap">
                            ...
                            <div class="card" style="width: 18rem;">
                                ...
                                <div class="overlaycon">
                                    <a href="{{url('/show-drawing/'.$item->id.'')}}"> <img   class="img-fluid" src="{{asset('drawing/'.$item->drawing.'')}}">
        ...
        countrySelectBox.onchange = function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    var url = "{{url('show-rang-drawing')}}" + "/" + eduShare + "/" + "1";
                    // console.log(url)
