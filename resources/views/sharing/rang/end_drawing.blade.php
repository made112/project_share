...
<h1 id="participate" style="text-align: center;">تقييم المشاركات من نوع رسومات</h1>
        ...
        <div class="col-lg-4  col-md-6 col-sm-12">
            <div class="card" style="width: 18rem;">
                <div class="overlaycon">
                    ...
                    <a href="{{url('/show-drawing/'.$item->id.'')}}"> <img   class="img-fluid" src="{{asset('drawing/'.$item->drawing.'')}}"></a>
