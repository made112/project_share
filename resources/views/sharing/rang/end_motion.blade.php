...
<br>
<h1 id="participate" style="text-align: center;">تقييمات المشاركات من نوع موشن جرافيك</h1>
        ...
        <div class="col-lg-4  col-md-6 col-sm-12">
            <div class="card" style="width: 18rem;">
                <div class="overlaycon">
                    ...
                    <a href="{{url('/show-motion/'.$item->id.'')}}"> <img   class="img-fluid" src="{{asset('img/motion.jpg')}}"></a>
