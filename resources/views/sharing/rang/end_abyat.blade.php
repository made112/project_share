...
<h1 id="participate" style="text-align: center;"> تقييم المشاركات من نوع  أبيات شعرية</h1>
        ...
        <div class="col-lg-4  col-md-6 col-sm-12">
            <div class="card" style="width: 18rem;">
                <div class="overlaycon">
                    ...
                    <a href="{{url('/show-abyat/'.$item->id.'')}}"> <img   class="img-fluid" src="{{asset('img/abyat.jpg')}}"></a>
