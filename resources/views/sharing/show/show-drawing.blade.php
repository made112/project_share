    ...
    <div class="all">
        <div class="row d-flex">
                ...
                <div class="left-part">
                    ...
                    <div class="row mb-0 d-flex">
                        ...
                        <div class="col-lg-6 col-12 order-lg-2 order-1">
                            <div class="row m">
                                <div class="col-4 white ara-b">رسومات</div>
                                <div class="col-8 green-light ara-b">النوع</div>
                            </div>
                            <div class="row mtx m mb-0">
                                <div class="col-12 green-light ara-b mb-4">
                                    <a href="{{route('download.drawing',$data->id)}}"> <button >تحميل المشاركة</button></a>
                                </div>
                                <div class="col-12 gray ara-b mb-4">
                                    <a href="{{url('view-drawing/1')}}"><button>العوده الى المعرض</button></a>
                                </div>
            ...
            <div class="col-xl-4 img-container order-xl-2 order-1">
                <img src="{{asset('drawing/'.$data->drawing.'')}}" alt="pic">
            </div>
        </div>
    </div>
</div>
