    ...
    <div class="all">
        <div class="row">
                ...
                <div class="left-part">
                    ...
                    <div class="row mb-0 d-flex">
                        ...
                        <div class="col-lg-6 col-12 order-lg-2 order-1">
                            <div class="row m">
                                <div class="col-4 white ara-b">مقالات</div>
                                <div class="col-8 green-light ara-b">النوع</div>
                            </div>
                            <div class="row mt-5 m mb-0">
                                <div class="col-12 green-light ara-b mb-4">
                                    <a href="{{route('download.blog',$data->id)}}"> <button >تحميل المشاركة</button><img style="height: 42px;width: 42px" src="{{asset('img/pdf .png')}}">
                                    </a>

                                </div>

                                <div class="col-12 gray ara-b mb-4">
                                    <a href="{{url('view-blog/3')}}"><button>العوده الى المعرض</button></a>
                                </div>
            ...
            <div class="col-lg-4 d-lg-block d-none img-container">
                <img src="{{asset('img/blog.jpg')}}" alt="pic">
            </div>
        </div>
    </div>
</div>
